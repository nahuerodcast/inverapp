        ...
        <Navbar bg="light">
          <Container className="footer-sm">
            <ul className="footer-list">
              <Link to={{ pathname: "https://facebook.com" }} target="_blank" className="text-decoration">
                <li>Facebook</li>
              </Link>
              <Link to={{ pathname: "https://twitter.com" }} target="_blank" className="text-decoration">
                <li>Twitter</li>
              </Link>
              <Link to={{ pathname: "https://instagram.com" }} target="_blank" className="text-decoration">
                <li>Instagram</li>
              </Link>
              <Link to={{ pathname: "https://linkedin.com" }} target="_blank" className="text-decoration">
                <li>LinkedIn</li>
              </Link>
            </ul>
          </Container>
